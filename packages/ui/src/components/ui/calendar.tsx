...
// Deterministic, locale-independent — Date#toLocaleDateString()/toLocaleString()
// resolve the runtime's default locale, which differs between the Node SSR
// pass and the browser and causes hydration mismatches on this data attribute.
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      formatters={{
        // Fixed locale, not "default": that resolves the runtime's locale,
        // which differs between the Node SSR pass and the browser.
